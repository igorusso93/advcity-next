                ...
                <div className="row">
                  ...
                  <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                    <div className="service__top-text text-anim">
                      <p>
                        Ogni cliente rappresenta una nuova avventura, nuove sfide
                        e nuove scoperte.{" "}
                        <span>
                          Come ormai avrai capito siamo dei reali appassionati
                          <br /> di universi creativi,
                        </span>{" "}
                        amiamo metterci in gioco ed affrontare con nuovo
                        entusiasmo ogni missione.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="service__list">
                        ...
                        <a href="/social">
                          ...
                          >
                            ...
                            <div className="service__text">
                              <p>
                                Social Media Strategy Contenuti grafici
                                Copywriting
                              </p>
                            </div>
                            <div className="service__link">
                        ...
                        <a href="/healthcare-marketing">
                          ...
                          >
                            ...
                            <div className="service__text">
                              <p>
                                Markeing Strategy Media online ed offline Visual
                                Comunication
                              </p>
                            </div>
                            <div className="service__link">
                      ...
                      <div className="swiper-wrapper">
                        {[
                          ...
                          [
                            "02",
                            "Piano & Competitor",
                            "Visioniamo i competitor ed elaboriamo un piano d'azione",
                          ],
                          ["03", "Realizzazione", "Realizziamo la Brand Identity"],
                          [
                            "04",
                            "Revisione",
                            "Revisioniamo il materiale valutandone l’efficacia sul target",
                          ],
                          [
                            "05",
                            "Realizzazione",
                            "Materiale per la prima consegna al cliente",
                          ],
                          ["06", "Consegna", "Si va in scena: Social, Web, Advertising"],
                        ].map(([num, title, text]) => (
                          <div
                            key={num}
                            className="swiper-slide workflow__slide fade_left"
                          >
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                    <div className="service__top-text text-anim">
                      <p>
                        Da oltre 15 anni offriamo strategie e supporto per campagne
                        di comunicazione di successo in ogni settore.{" "}
                  ...
                  <div className="row">
                    <div className="col-xxl-4 col-xl-4 col-lg-0 col-md-0">
                      <div className="service__img-wrapper">
                        ...
                        <span
                          className="shape-box-1 current"
                          style={{ backgroundColor: "#0079A7" }}
                        ></span>
                        <span
                          className="shape-box-2"
                          style={{ backgroundColor: "#0079A7" }}
                        ></span>
                        <span
                          className="shape-box-3"
                          style={{ backgroundColor: "#0079A7" }}
                        ></span>
                        <span
                          className="shape-box-4"
                          style={{ backgroundColor: "#0079A7" }}
                        ></span>
                      </div>
                    </div>
                ...
                <div className="row top_row">
                  ...
                  <div className="portfolio__list-1">
                    {[
                      ...
                      ["sorrentino", "Salvatore Sorrentino", "2021", "/assets/imgs/portfolio/sorrentino.jpg"],
                      ...
                      ["scintille", "Scintille Idee Preziose", "2022", "/assets/imgs/portfolio/scintille.jpg"],
                      ["crtf", "CRTF", "2021", "/assets/imgs/portfolio/crtf.jpg"],
                      ...
                      ["dentalam", "Dentalam", "2024", "/assets/imgs/portfolio/dentalam.jpg"],
                      ["gustosa", "La Gustosa", "2024", "/assets/imgs/portfolio/gustosa.jpg"],
                    ].map(([slug, title, year, img]) => (
                      <div className="portfolio__item" key={slug}>
                        <a href={`/portfolio/${slug}`}>
                          <img
                            className={slug === "orogiallo" ? "mover" : undefined}
                            src={img}
                            alt={title}
                          />
                        </a>
                  ...
                  {[
                    {
                      ...
                      date: "11.10.2024",
                      title:
                        "LA SCHEDA GOOGLE: il biglietto da visita digitale che (forse) stai trascurando",
                      img: "/assets/imgs/blog/schedagooglehome.jpg",
                    },
                    {
                      href: "/formatisocial",
                      date: "14.10.2024",
                      title:
                        "I formati social: le dimensioni corrette delle immagini per una buona comunicazione online",
                      img: "/assets/imgs/blog/formatsocial.jpg",
                    },
                    {
                      href: "https://advcity.com/socialmedia2026.html",
                      date: "15 gennaio 2026",
                      title:
                        "Social Media 2026: verso meno “pettegolezzo digitale” e più valore per brand e imprese",
                      img: "https://advcity.com/assets/Social2026storia.jpg",
                      external: true,
                    },
                  ].map((p) => (
                        ...
                        <div className="blog__img-wrapper">
                          ...
                          >
                            <div className="img-box">
                              <img className="image-box__item" src={p.img} alt="" />
                              <img className="image-box__item" src={p.img} alt="" />
                            </div>
                          </a>
                        </div>
